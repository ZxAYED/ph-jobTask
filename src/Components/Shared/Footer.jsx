const Footer = () => {
    return (
      <footer className="bg-[#001f3f] text-white mt-28">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white">Connect</h2>
              <ul className="text-gray-400 dark:text-gray-400 font-medium">
                <li className="mb-4">
    ...
    <div className="px-4 py-6  rounded-xl gap-4 md:flex md:items-center md:justify-between">
        <div className=" flex gap-5 items-center text-gray-500 text-sm"><span className="bg-gradient-to-r from-blue-800 via-blue-500 to-blue-300 text-transparent bg-clip-text text-xl md:text-3xl font-bold  ">
  TaskGuard Pro
</span> All Rights Reserved.
        </div>
        <div className="flex mt-4 p-6 sm:justify-center md:mt-0  space-x-5 rtl:space-x-reverse">
