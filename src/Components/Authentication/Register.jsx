...
const Register = () => {
   ...
   const Image= res.data.data?.display_url || ''
        ...
        handleRegister(data.email, data.password,UserName,Image)
            .then(res => {
                                        ...
                                        <div className="mt-8">
                                            <div className="mt-6">
                                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                                    ...
                                                    <div>
                                                        <button type="submit" className="flex items-center justify-center w-full items-center block px-auto py-3.5 text-base font-medium bg-[#001f3f]  text-center mx-auto text-white   shadow-md rounded-xl  hover:text-[#001f3f]  hover:bg-blue-500 ">Register</button>
                                                    </div>
                                                </form>
                                                ...
                                                <Link to='/Login'><p className='mt-6 text-center '>Already have an account in <span className="bg-gradient-to-r from-blue-800 via-blue-500 to-blue-300 text-transparent bg-clip-text font-bold  ">
  TaskGuard Pro
</span> ? Click here to  <span className='text-[#4386c9] text-semibold'>Log In</span></p></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
