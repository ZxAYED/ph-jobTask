                                    ...
                                    <div className="w-full max-w-xl mx-auto lg:w-96">
                                        ...
                                        <div className="mt-8">
                                            <div className="mt-6">
                                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            <input id="remember-me" name="remember-me" type="checkbox" placeholder="Your password" className="w-4 h-4  hover:text-[#001f3f]  hover:bg-blue-500  rounded hover:transition-transform hover:duration-200 border-gray-200  focus:ring-blue-500" />
                                                            <label className="block ml-2 text-sm text-neutral-600"> Remember me </label>
                                                        </div>

                                                        <div className="text-sm">
                                                            <a href="#" className="font-medium text-[#001f3f] hover:text-blue-500"> Forgot your password? </a>
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <button type="submit" className="flex items-center justify-center w-full  px-auto py-3.5 text-base font-medium bg-[#001f3f]  text-center mx-auto text-white   shadow-md rounded-xl  hover:text-[#001f3f]  hover:bg-blue-500 ">Sign in</button>
                                                    </div>
                                                </form>
                                                ...
                                                <div>
                                                    <button onClick={google} className="w-full items-center block px-auto py-3.5 text-base font-medium bg-[#001f3f]  text-center mx-auto text-white   shadow-md rounded-xl  hover:text-[#001f3f]  hover:bg-blue-500 ">
                                                ...
                                                <Link to='/Register'><p className='mt-6 text-center '>New to  <span className="bg-gradient-to-r from-blue-800 via-blue-500 to-blue-300 text-transparent bg-clip-text font-bold  ">
  TaskGuard Pro
</span> ? Click here to  <span className='text-[#4386c9] text-semibold'>Register</span></p></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="w-full bg-[#001f3f] rounded-2xl mt-10 lg:mt-0  px-6 py-3">
